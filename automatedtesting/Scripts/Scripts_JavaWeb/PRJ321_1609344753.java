...
@SpringBootTest
class ScripTestJava {
    public static String questionPointStr = "testcase:1-testcase:1";
    @Autowired
...
@Test 
@Order(1) 
public void testcase(){driver.findElement(By.id($paramName)).clear(); driver.findElement(By.id($paramName)).sendKeys($paramValue);}@Test 
@Order(1) 
